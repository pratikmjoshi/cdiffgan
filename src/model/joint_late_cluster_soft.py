...
JointLateClusterSoft_D = Speech2Gesture_D
LateClusterSoft_D = Speech2Gesture_D

class JointLateClusterSoft_G(nn.Module):
  '''
...
class LateClusterSoft_G(JointLateClusterSoft_G):
  '''
  Late Fusion with clustering in the input pose
  ...
  '''
  def __init__(self, time_steps=64, in_channels=256, out_feats=104, p=0, num_clusters=8, cluster=None, **kwargs):
    super().__init__(time_steps, in_channels, out_feats, p, num_clusters, cluster, **kwargs)

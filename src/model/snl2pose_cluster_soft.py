...
SnL2PoseLateClusterSoft_D = Speech2Gesture_D

class SnL2PoseLateClusterSoft_G(nn.Module):
  '''
...
#      labels_cap = labels ## use ground truth while training
    ...
    #labels_out_cap = kwargs['cluster'](x, soft_labels=True)
    #pdb.set_trace()
    #internal_losses.append(self.classify_loss(labels_out_cap.reshape(-1, labels_out_cap.shape[-1]), labels.reshape(-1)))

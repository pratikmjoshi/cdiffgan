...
def get_args_perm():
  ...
  parser.add_argument('-feats', nargs='+', type=literal_eval, default=[['pose', 'velocity', 'speed']],
  ...
  parser.add_argument('-pretrained_model_weights', nargs='+', type=str, default=[None],
                      help='paths to pretrained_weights')  
  ...
  parser.add_argument('-wandb', nargs='+', type=int, default=[0],
                      help='Send data to weights and biases')
  parser.add_argument('-wandb_project', nargs='+', type=str, default=['Test'],
                      help='Wandb Project Name')
  parser.add_argument('-wandb_dir', nargs='+', type=str, default=['wandb'],
  ...
  parser.add_argument('-trainer', nargs='+', type=str, default=[None],
                      help='Force Choose a trainer. If None, figure out the trainer based on model and paradigm')    

  ## GAN params
  parser.add_argument('-gan', nargs='+', type=str, default=[False],
  ...
  ## fewshot learning params
  parser.add_argument('-cache', nargs='+', type=int, default=[0],
                      help='do not load all the data. Instead cache the data as you train')
  parser.add_argument('-fewshot_seed', nargs='+', type=int, default=[None],
                      help='manual seed for fewshot learning. if not None FewshotData will be loaded')
  parser.add_argument('-k_shot', nargs='+', type=int, default=[None],
                      help='number of samples used for training a model')
  parser.add_argument('-p_avg', nargs='+', type=int, default=[1],
                      help='number of k_shot training sets to measure robustness of the model')
  parser.add_argument('-paradigm', nargs='+', type=str, default=[None],
                      help='Paradigm for Training: src_only, tgt_only, src_tgt, no_src_tgt(or None)')

  ## cl learning params
  parser.add_argument('-replay', nargs='+', type=str, default=[None],
                      help='''set to different values for  replay based continual learning.
                      modifies the training sampler of the target data''')
  ...
  parser.add_argument('-sequel', nargs='+', type=str, default=[None],
                      help='sequel to the script in slurm_generator')
  ...
  ## debug args
  parser.add_argument('-mem_usage', nargs='+', type=int, default=[0],
                      help='print mem_usage')  

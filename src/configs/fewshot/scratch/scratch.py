...
src_speakers = ['lec_cosmic']
tgt_speakers = ['chemistry', 'ytch_prof', 'oliver', 'maher', 'lec_evol']
...
## pretrained_models
pretrained_model_weights = ['"' + "save6/fewshot/dummy/exp_4760_cpk_aisle_noise_speaker_['lec_cosmic']_model_JointLateClusterSoftTransformerNoise_G_note_aisle_noise_weights.p" + '"']*len(tgt_speakers)
...
model = 'TransferringGAN_G'
modelKwargs = [{'tgt_train_ratio':1}]
note = 'scratch_{}'.format(paradigm)

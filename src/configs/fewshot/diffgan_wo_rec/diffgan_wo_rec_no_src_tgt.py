...
#tgt_speakers = ['chemistry', 'oliver', 'maher']
#tgt_speakers = ['ytch_prof', 'lec_evol']
...
model = 'DiffGAN2_G'
modelKwargs = [{'tgt_train_ratio':1, 'get_pretrained_D':1, 'fewshot_style':1, 'fewshot_timing':1, 'fewshot_rec':0}]
note = 'diffgan_wo_rec_{}'.format(paradigm)

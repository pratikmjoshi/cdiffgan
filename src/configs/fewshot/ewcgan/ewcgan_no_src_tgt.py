...
tgt_speakers = ['chemistry', 'ytch_prof', 'oliver', 'maher', 'lec_evol', 'sp0001', 'sp0003', 'sp0006']
...
model = 'ewcGAN_G'
modelKwargs = [{'tgt_train_ratio':1, 'get_pretrained_D':1, 'ewc_lambda':i} for i in [1, 1e4]] #5e8
note = 'ewcgan_{}'.format(paradigm)
